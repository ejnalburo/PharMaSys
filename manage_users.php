      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">User's Table</li>
          </ol>
          <h1>User's Table</h1>
          ...
          <div class="row margin-bottom-20">
            <div class="col-md-12">
              <ul class="nav nav-pills">
                 <li class="active"><a href="manage_users.php"><h9>All Users</h9><span class="badge"><input type="text" name="" id="bag" disabled="" style="outline: none; border: none; width: 40px; text-align: center;"></span></a></li>
              </ul>          
            </div>
          </div> 
          <div class="pull-right">
                <ul class="nav nav-pills">
                  <button class="btn btn-success" class="add_new_stock" id="add_new_stock"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add New User</button>
                </ul>
                </div>  
          <br>
          <br>
                ...
                <table class="table table-responsive compact" style="width: 100%;" id="usersdata">
                  ...
                  <tbody> 
                    ...
                    if($rows>0)
                    {
                        ...
                        {
                    ?>
                      <tr class="user_<?php echo $data['rid']; ?>">
                        ...
                        <td>
                          <a href="javascript:void(0);" style="text-decoration: none;" onclick="reset_pass('<?php echo $data['rid'];?>','<?php echo $data['userType'];?>')" title="Reset Password"><i class="fa fa-undo" style="color: #1d6924"></i>&nbsp;Reset Password</a>&nbsp;&nbsp;&nbsp;
                          <a href="javascript:void(0);" style="text-decoration: none;" onclick="edit_user('<?php echo $data['rid'];?>')" title="Edit User"><i class="fa fa-edit" style="color: #1d6924"></i>&nbsp;Edit</a>&nbsp;&nbsp;&nbsp;
                          <a href="javascript:void(0);" style="text-decoration: none;" onclick="delete_user('<?php echo $data['rid'];?>')" title="Delete User"><i class="fa fa-trash-o" style="color: #1d6924"></i>&nbsp;Delete</a>&nbsp;&nbsp;&nbsp;
                        </td>
                      </tr> 
                    <?php
                        }
