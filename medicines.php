        ...
        <div class="templatemo-content">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <ul class="nav nav-pills">
                  <li class="active"><a href="#"><h9>Medicine Stocked</h9><span class="badge">30</span></a></li>
                  <li class="active"><a href="#"><h9>Medicine Dispensed</h9><span class="badge">150</span></a></li>
                </ul>    
                ...
                <ul class="nav nav-pills">
                  ...
                  <li class="active"><button class="btn btn-success" onclick="printDiv('usersdata')"><span class="badge"><i class="fa fa-print"></i></span> Print Data </button></li>
                </ul>
                </div>          
              </div>
            </div>
          ...
          <div class="row margin-bottom-30">
            <div class="col-md-12">
                ...
                <table class="table table-striped table-bordered table-responsive" style="width: 100%;" id="usersdata">
                  <thead>
                    <tr>
                        <th>ID</th>
                        <th>Brand Name</th>
                  ...
                  <tbody>
                    ...
                    if($rows>0)
                    {
                        ...
                        {
                    ?>
                       <tr class="user_<?php echo $data['medicineID']; ?>">
                        <td><?php echo $data['medicineID']; ?></td>
                        ...
                        <td>
                            <a href="javascript:void(0);" style="text-decoration: none;" onclick="edit_user('<?php echo "a";?>')"><i class="fa fa-edit" style="color: #1d6924"></i> Edit</a>
                        </td>
                    </tr>
                    <?php
                        }
      ...
      <thead></thead>
        <tbody>
          <tr>
            ...
            <th style="border: 1px solid; border-collapse: collapse; text-align: center;">Brand</th>
            <th style="border: 1px solid; border-collapse: collapse; text-align: center;">Generic</th>
            <th style="border: 1px solid; border-collapse: collapse; text-align: center;">Strength</th>
            <th style="border: 1px solid; border-collapse: collapse; text-align: center;">Form</th>
            <th style="border: 1px solid; border-collapse: collapse; text-align: center;">Volume</th></strong>
          </tr>
          ...
          ?>
                <tr class="user_<?php echo $data['medicineID']; ?>">
                  <td style="border: 1px solid; border-collapse: collapse;"><?php echo $data['medicineID']; ?></td><td style="border: 1px solid; border-collapse: collapse;"><?php echo $data['brand']; ?></td>
                  <td style="border: 1px solid; border-collapse: collapse;"><?php echo $data['generic']; ?></td>
                  <td style="border: 1px solid; border-collapse: collapse;"><?php echo $data['strength']; ?></td>
                  <td style="border: 1px solid; border-collapse: collapse;"><?php echo $data['form']; ?></td>
                  <td style="border: 1px solid; border-collapse: collapse;"><?php echo $data['volume']; ?></td>
                </tr>
          <?php
                }
              }
