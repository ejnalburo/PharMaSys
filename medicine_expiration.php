          ...
          <li class="sub" >
           ...
           <li class="sub open" style="background-color: rgb(191, 232, 167);">
            ...
            <ul class="templatemo-submenu">
              ...
              <li  style="background-color: rgb(191, 232, 167);"><a href="medicine_expiration.php" style="text-decoration: none; font-size: 12px;">Medicine Expiration Status</a></li>
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">Medicine Expiration Status</li>
          </ol>
          <h1>Expiration Status</h1>
          <p></p>
          ...
          <div class="margin-bottom-30">
            <div class="row">
              ...
              <table class="table table-responsive compact" style="width: 100%; width: 100%; border-style: 1px solid; border-collapse: collapse;" id="usersdata">
                    <thead>
                    <tr>
                    ...
                    <tbody style="width: 100%; border-style: 1px solid; border-collapse: collapse;">
                   <?php include'filter_expiration.php'?>
                </tbody>   
                </table> 
              </div>
                </div>
              ...
              <div class="btn-group pull-right" id="templatemo_sort_btn" style="margin-top: 3px; margin-right: 3px;">
                <button type="button" class="btn btn-default" style="margin-right: 2px;" onclick="printDiv1()"><i class="fa fa-print"></i>&nbsp;Print</button>
                  ...
                  <div class="panel-heading">Expired Medicines</div>
                  <div class="panel-body">
              <div class="table-responsive">
              <table class="table table-bordered table-responsive compact" style="width: 100%; width: 100%; border-style: 1px solid; border-collapse: collapse;" id="userdata">
                    <thead>
                    <tr>
                        <th style="border: 1px solid; text-align: center; border-collapse: collapse;">ID</th>
                        <th style="border: 1px solid; text-align: center; border-collapse: collapse;">Medicine Name</th>
                   ...
                   <?php 
                    ...
                    $sql = "SELECT * FROM medicine_stock WHERE dateExpired <= curdate() ORDER BY dateExpired DESC";
...
<div class="modal fade" id="promptCoor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-body">
            <form>
              <label for="coordinator">Enter Name of Coordinator:</label><span class="coor_error error" style="color: red;"></span>
              <input type="text" name="coordinator" id="coordinator" class="form-control" required="" oninput="cl()">
              <input type="hidden" name="inventoryID" id="inventoryID">
            </div>
            <div class="modal-footer">
              <button type="button" onclick="dispenseMed(coordinator.value, inventoryID.value)" class="btn btn-primary">Submit</button>
...
<div id ="printableTable">
  <center><p style="text-align: right;"><script> document.write(new Date().toLocaleDateString()); </script></p>
    ...
    <br>
    <h9><strong>List of Nearly Expired Medicines</strong></h9>
...
<div id ="printableTable1">
  <center><p style="text-align: right;"><script> document.write(new Date().toLocaleDateString()); </script></p>
    <h3><strong>City Health Office</strong></h3>
    <br>
    <h9>List of Expired Medicines</h9>
    
 <table class="table table-responsive compact" style="width: 100%; border: 1px solid; text-align: center; border-collapse: collapse;" id="userdata">
                    <thead  style="border: 1px solid; text-align: center; border-collapse: collapse;">
                    <tr>
                        <th style="border: 1px solid; text-align: center; border-collapse: collapse;">Medicine Name</th>
                        <th style="border: 1px solid; text-align: center; border-collapse: collapse;">Description</th>
                        <th style="border: 1px solid; text-align: center; border-collapse: collapse;">Quantity</th>
