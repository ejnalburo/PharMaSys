      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li><a href="medicine_dispense.php">Dispense Medicines</a></li>
            <li class="active">Medicine Dispensed</li>
          </ol>
          <h1>Medicine Dispensed Today</h1>
          <p></p>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-primary">
                  <div class="panel-heading">List of All Medicines Dispensed Today</div>
              ...
              <table class="table table-striped table-responsive compact" style="width: 100%;" id="usersdata">
                    ...
                    $sql = "SELECT * FROM medicine_dispense WHERE release_date = curdate() ORDER BY dispenseID desc";
                    ...
                    if($rows>0)
                    {
                        ...
                        {
                    ?>
                       <tr class="user_<?php echo $data['dispenseID']; ?>">
                        <td><?php echo $data['dispenseID'];?></td>
                        <td><?php echo $data['coorName'];?></td>
                        ...
                        <td><?php echo $data['release_date'];?></td></td>
                    </tr>
                     <?php
                        }
                    }
        ...
        <div class="templatemo-alerts">
          <div class="row">
            <div style="display: inline-block; margin-left: 15px; margin-bottom: 10px;">
              ...
              <input type="text" class="form-control" id="inventoryID" name="inventoryID" style="width: 250px;" oninput="cl5()">
            </div>
            ...
            <div style="display: inline-block; margin-left: 60px; margin-bottom: 10px;">
              ...
              <input type="text" class="form-control" id="program" name="program" style="width: 250px;" oninput="cl6()">
           </div> 
          </div>            
        </div>              
      </div>
        ...
        <div class="templatemo-alerts">
          <div class="row">
            <div style="display: inline-block; margin-left: 15px; margin-bottom: 10px;">
              ...
              <input type="text" class="form-control" id="brand" name="brand" style="width: 250px;" oninput="cl5()">
            </div>

            <div style="display: inline-block; margin-left: 60px; margin-bottom: 10px;">
              <label for=""><strong>Generic Name:</strong></label><span class="generic_error error" style="color: red;"></span>
              <input type="text" class="form-control" id="generic" name="generic" style="width: 250px;" oninput="cl6()">
           </div> 
          </div>            
        </div>              
      </div>
        ...
        <div class="templatemo-alerts">
          <div class="row">
            <div style="display: inline-block; margin-left: 15px; margin-bottom: 10px;">
              ...
              <input type="text" class="form-control" id="strength" name="strength" style="width: 250px;" oninput="cl5()">
            </div>

            <div style="display: inline-block; margin-left: 60px; margin-bottom: 10px;">
              <label for=""><strong>Form:</strong></label><span class="form_error error" style="color: red;"></span>
              <input type="text" class="form-control" id="form" name="form" style="width: 250px;" oninput="cl6()">
           </div> 
          </div>            
        </div>              
      </div>
        ...
        <div class="templatemo-alerts">
          <div class="row">
            <div style="display: inline-block; margin-left: 15px; margin-bottom: 10px;">
              ...
              <input type="text" class="form-control" id="volume" name="volume" style="width: 250px;" oninput="cl5()">
            </div>

            <div style="display: inline-block; margin-left: 60px; margin-bottom: 10px;">
              <label for=""><strong>Quantity:</strong></label><span class="quantity_error error" style="color: red;"></span>
              <input type="text" class="form-control" id="quantity" name="quantity" style="width: 250px;" oninput="cl6()">
           </div> 
          </div>            
        </div>              
      </div>
...
$.ajax({
    ...
    function promptCoor(inventoryID, program, brand, generic, strength, form, volume, quantity){
