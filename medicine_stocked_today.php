      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li><a href="medicine_stock.php">Stock Medicines</a></li>
            <li class="active">Medicine Stocked</li>
          </ol>
          <h1>Medicine Stocked Today</h1>
          <p></p>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-primary">
                  <div class="panel-heading">List of All Medicines Stocked Today</div>
              ...
              <table class="table table-striped table-responsive compact" style="width: 100%;" id="usersdata">
                    ...
                    $sql = "SELECT * FROM medicine_stock WHERE quantity > 0 AND dateStocked = curdate() ORDER BY inventoryID desc";
                    ...
                    ?>
                       <tr class="user_<?php echo $data['inventoryID']; ?>">
                        ...
                        <td><?php echo $data['strength'] . "/ " . $data['form']. "/ " . $data['volume'];?></td>
                        ...
                        <td>
                            <a href="javascript:void(0);" style="text-decoration: none;" onclick="generate_barcode('<?php echo $data['barcode'];?>')" title="Generate Barcode"><i class="fa fa-barcode" style="color: #1d6924"></i></a>&nbsp;&nbsp;&nbsp;
                            <a href="javascript:void(0);" style="text-decoration: none;" onclick="edit_user('<?php echo $data['inventoryID'];?>','<?php echo $data['programID'];?>')" title="Edit"><i class="fa fa-edit" style="color: #1d6924"></i></a>&nbsp;&nbsp;&nbsp;
                        </td>
                    </tr>
                     <?php
                        }
...
<div class="modal fade" id="generate_barcode_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <input type="text" name="baa" id="baa" value="">
                <label>How many barcodes do you want to print?&nbsp;&nbsp;</label>
                <input type="number" name="amount" id="amount">
            </div>
            <div class="modal-footer">
              <button type="submit" id="sb" class="btn btn-primary">Submit</button>
...
<div class="modal fade" id="add_new_stock_modal" tabindex="-1" aria-hidden="true">
  ...
  <form method="post" role="form" action="$_SERVER['PHP_SELF']">
            ...
            <div style="display: inline-block; margin-bottom: 40px;">
              <button type="button" onclick="generate_barcodes()" class="btn btn-primary"><i class="fa fa-refresh">&nbsp;&nbsp;<span>Generate</span></i></button>       
            </div> 
        ...
        <div class="templatemo-alerts">
          <div class="row">
            ...
            <div style="display: inline-block; margin-left: 60px; margin-bottom: 10px;">
              ...
              <input type="number" class="form-control" id="quantity" name="quantity" placeholder="Quantity" style="width: 250px;" oninput="cl6()">
           </div> 
        </div>            
        </div>              
     </div>
    ...
    <div class="row">
      <div class="col-md-12">
       ...
       ?>
            ...
            <div style="display: inline-block; margin-left: 60px; margin-bottom: 10px;">
              <label for=""><strong>Volume:</strong></label><span class="volume_error error" style="color: red;"></span>
              <input type="text" class="form-control" id="volume" name="volume" placeholder="Volume" style="width: 250px;" oninput="cl10()">
            </div> 
        </div>            
        </div>              
     </div>
