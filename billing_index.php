...
<body>
  <div class="navbar navbar-inverse" role="navigation" style="color: #ccc; background-color: #8d8d8d; border: none;">
    ...
    <div class="template-page-wrapper">
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
          ...
          <li class="active"><a href="billing_index.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>

          <li><a href="patient_billing.php"><i class="fa fa-dollar"></i>Billing</a></li>
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li><a href="billing_index.php">Dashboard</a></li>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <ul class="nav nav-pills">
                  ...
                  <li class="active"><a href="#">Total Products Sold<span class="badge"><input type="text" name="" id="bad" disabled="" style="outline: none; border: none; width: 40px; text-align: center;"></span></a></li>
                </ul>          
              </div>
            </div>
          </div>     
    ...
    $.ajax({
      url : "get_total_products_count.php",
            dataType : "json",
