    ...
    <div class="template-page-wrapper">
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
          ...
          <li class="active"><a href="add_patients.php"><i class="fa fa-wheelchair"></i>Patients</a></li>
      ...
      <div class="templatemo-content-wrapper" style="max-height: 1000px;">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            <li><a href="patient_index.php">Admin Panel</a></li>
            <li><a href="add_patients.php">Patients</a></li>
            ...
            <div class="row">
              ...
              <h9>As of Today:</h9>
                <ul class="nav nav-pills">
                   <li class="active"><a href="#"><h9>Patients Consulted</h9><span class="badge"><input type="text" name="" id="bad" disabled="" style="outline: none; border: none; width: 40px; text-align: center;"></span></a></li>
                </ul>  
                <div class="pull-right">
                  <ul class="nav nav-pills">
                    <button class="btn btn-success" class="add_new_patient" id="add_new_patient"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add New Patient</button>
                  </ul>
                </div>          
              </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-primary">
                  <div class="panel-heading">List of All Patients</div>
              ...
              <div class="table-responsive">
                ...
                <thead>
                  <tr>
                    ...
                    <th style="text-align: center;">Last Date Consulted</th>
                ...
                <tbody>
                  <?php
                    ...
                    include 'config.php';
                    $sql = "SELECT a.patientID as patientID, a.bloodType as blood, c.brgyName as brgyName, a.lastname as lastname, a.firstname as firstname, a.sex as sex, year(CURDATE())-year(a.age) as age, date_format(a.date_date, '%M %d %Y') as dates FROM patients a, barangay c WHERE a.brgyID = c.brgyID GROUP BY a.lastname, a.firstname ORDER BY a.date_date";
                  ...
                  <tr class="user_<?php echo $data['patientID']; ?>">
                    ...
                    <td style="text-align: center;"><?php echo $data['blood'];?></td>
                    <td style="text-align: center;"><?php echo $data['brgyName'];?></td>
                    <td style="text-align: center;"><?php echo $data['dates'];?></td>
                    <td style="text-align: center;"><a href="javascript:void(0)" style="text-decoration: none;" onclick="viewDetails('<?php echo $data["patientID"];?>')">&nbsp;&nbsp;&nbsp;&nbsp;<span><i class="fa fa-eye"></i>&nbsp;View History</span></a></td>
                  </tr>
  ...
  <div class="modal fade" id="viewDetailsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog" role="document" style="margin-left: 230px;">
      <div class="modal-content"  style="width: 950px;">
        <div class="modal-header">
          <button type="button" onclick="refreshh()" class="close" data-dismiss="modal" aria-label="Close">
    ...
    <h3 style="text-align: center; font-size: 16px;">Patient History</h3>
        ...
        <div class='modal-footer'>
          <button type='button' class='btn btn-danger' onclick="refreshh()" data-dismiss='modal'>Close</button>
          </div>  
      </div>
    </div>
  </div>
...
<div class="modal fade" id="add_new_patient_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
  ...
  <form method="post" role="form" action="$_SERVER['PHP_SELF']">
        ...
        <div class="templatemo-alerts">
          <div class="row">
            <div style="display: inline-block; margin-left: 15px; margin-bottom: 10px;">
              ...
              <input type="text" class="form-control" placeholder="First Name" style="width: 250px;" oninput="cl1()" required="" name="firstname" id="firstname">
            </div>
            ...
            <input type="text" class="form-control" placeholder="Last Name" style="width: 250px;" oninput="cl2()" required="" name="lastname" id="lastname">
           </div> 
        </div>            
        </div>              
     </div>
    ...
    <div class="row">
      <div class="col-md-12">
         <div class="templatemo-alerts">
           <div class="row">
            <div style="display: inline-block; margin-left: 15px; margin-bottom: 10px;">
               <label for=""><strong>Gender:</strong></label><span class="sex_error error" style="color: red;"></span>
               <select class="form-control" style="width: 250px;" name="sex" id="sex" oninput="cl3()">
             ...
             <div style="display: inline-block; margin-left: 60px; margin-bottom: 10px;">
               <label for=""><strong>Birth Date:</strong></label><span class="age_error error" style="color: red;"></span>
                <input type="Date" class="form-control" placeholder="Birth Date" style="width: 250px;" oninput="cl4()" required="" name="age" id="age">
           ...
           <div class="row">
              <div style="display: inline-block; margin-left: 15px; margin-bottom: 10px;">
               <label for=""><strong>Blood Type:</strong></label><span class="blood_error error" style="color: red;"></span>
                <input type="text" class="form-control" placeholder="Blood Type" style="width: 250px;" oninput="cl6()" required="" name="blood" id="blood">

             </div> 
            <div style="display: inline-block; margin-left: 60px; margin-bottom: 10px;">
               <label for=""><strong>Barangay:</strong></label><span class="brgy_error error" style="color: red;"></span>
               <select class="form-control" style="width: 250px;" name="brgyID" id="brgyID" oninput="cl5()">
              <?php  
              include 'config.php';
              ...
              ?>
                 <option id="brgyID" value="<?php echo $data['brgyID'];?>"><?php echo $data['brgyName'];?></option>
              <?php
              }
              ?>
               </select>
    ...
    $("#add_new_patient").click(function(){
      ...
      $('#blood').val("");
      $("#brgyID").val("");
      $('#add_new_patient_modal').modal("show");
    });
...
$.ajax({
            ...
            success: function(response){
                if(response['valid']==false){
                    ...
                    if(action == 'add'){
                        $("#add_new_patient_modal").modal('hide');
                        html += "<tr class=user_"+response['patientID']+">";
                        html += "<td style='text-align: center;'>"+response['patientID']+"</td>";
                        html += "<td>"+response['lastname']+"</td>";
                        html += "<td>"+response['firstname']+"</td>";
                        html += "<td style='text-align: center;'>"+response['age']+"</td>";
                        html += "<td style='text-align: center;'>"+response['sex']+"</td>";
                        html += "<td style='text-align: center;'>"+response['blood']+"</td>";
                        html += "<td style='text-align: center;'>"+response['brgyName']+"</td>";
                        html += "<td style='text-align: center;'>"+response['dates']+"</td>";
                        html += "<td style='text-align: center;'><a href='javascript:void(0)' style='text-decoration: none;' onclick='viewDetails("+response['lastname']+", "+response['firstname']+")'>&nbsp;&nbsp;&nbsp;&nbsp;<span><i class='fa fa-eye'></i>&nbsp;View History</span></a>";
                        html += "<tr>";
