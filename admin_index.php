    ...
    <div class="template-page-wrapper">
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
          ...
          <li class="active"><a href="admin_index.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
        ...
        <div class="templatemo-content">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <ul class="nav nav-pills">
                  <li class="active"><a href="medicine_stocked_today.php">Medicine Stocked&nbsp;<span class="badge"><input type="text" name="" id="bas" disabled="" style="outline: none; border: none; width: 40px; text-align: center;"></span></a></li>
                  <li class="active"><a href="medicine_dispensed_today.php">Medicine Dispensed&nbsp;<span class="badge"><input type="text" name="" id="bad" disabled="" style="outline: none; border: none; width: 40px; text-align: center;"></span></a></li>
                  <li class="active"><a href="#">Total Sales&nbsp;<span class="badge"><input type="text" name="" id="baf" disabled="" style="outline: none; border: none; width: 70px; text-align: center;"></span></a></li>
                </ul>          
              </div>
            </div>
          </div>         
          ...
          <div class="row">
              ...
              <div class="templatemo-alerts">
                <div class="row">
                  <div class="col-md-4 col-sm-6 margin-bottom-30">
                    ...
                    <span class="btn btn-success pull-right"><a href="medicine_inventory.php">Go to Medicine Inventory Status Report</a></span> 
                  </div>  
                ...
                <div class="panel panel-success">
                 ...
                 <span class="btn btn-success pull-right"><a href="sales_report.php">Go to Sales Report</a></span>     
                </div>  
            ...
            <div class="col-md-12 margin-bottom-30">
                ...
                <span  class="btn btn-primary pull-right"><a href="medicine_expiration.php">Go to Medicine Expiration Status Report</a></span>
              </div>
