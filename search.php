...
error_reporting(0);
session_start();
if($_SESSION['username']=="" || $_SESSION['userType']!="Billing") {
        ...
        <div class="templatemo-content">
          ...
          <div class="row" style="">
            ...
            <?php 
               ...
               if($rows>0)
               {
                 echo '<input type="text" class="form-control" list="datalist5" onclick ="hides()" id="name" name="name" placeholder="Search Patient Name" style="width: 250px;" oninput="cl9()">';
        ...
        <div class="row">
            ...
            <div class="table-responsive">
              <table class="table table-responsive compact" style="width: 100%;" id="userdata">
                    ...
                    $sql="SELECT patientID FROM patients WHERE CONCAT(firstname, ' ', lastname) LIKE '%".$_POST["name"]."%'";
                    $result=mysqli_query($conn, $sql);

                    $data = mysqli_fetch_assoc($result);

                    $output = $data['patientID'];

                        $sql1="SELECT * FROM prescription WHERE purchased = '0' AND patientID = '$output'";
                    ...
                    ?>
                       ...
                       <tr class="aaa">
                        ...
                        <td><?php echo $data1['generic'];?></td>
                        <td><?php echo $data1['strength'];?></td>
                        <td><?php echo $data1['form'];?></td>
                        ...
                        $sql = "SELECT * FROM medicine_stock WHERE brand = '$br' AND generic = '$ge' AND strength = '$st' AND form = '$fo'";
                        $query = mysqli_query($conn, $sql);
                        $rows = mysqli_num_rows($query);

                        if ($rows > 0) {
                            $sql = "SELECT SUM(quantity) as q FROM medicine_stock WHERE brand = '$br' AND generic = '$ge' AND strength = '$st' AND form = '$fo'";
                            $query = mysqli_query($conn, $sql);
                    ...
                    <?php
                        ...
                        <tr class="aaa">
                        <td><center><p>No data found!</p></center></td>
                        </tr>
            ...
            <table name="cart" class="table table-striped table-bordered compact" id="usersdata">
              <thead>
                ...
                <tr>
                    ...
                    <td><input type="number" id="consultation_fee" name="consultation_fee" style="border: none; width: 70px; height: 20px;" min="0" value="0.00"></td>
                    <td></td>
                </tr>
                ...
                <tr>
                    <td colspan="3">&nbsp;</td>
                    <th>Total</th>
                    <td><input type="text" id="sub_total" name="sub_total" value="" style="border: none; width: 70px;" disabled="" jAutoCalc="{item_total} + {consultation_fee}" id=""></td>
                    <td></td>
                </tr>
                </tbody>
            </table>
      ...
      <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div id="ticket" style="resize: both;"><center>
            ...
            <?php 
                    ...
                    $sql = "SELECT * FROM billings WHERE transactionID = '' ORDER BY billID desc";
                ...
                <h9>Receipt ID: <?php echo $data['billID'];?></h9>
                <br>
                <h9>Patient Name: </h9>
                <br>
                <h9>Address: Panabo City</h9>
                <br>
                <br>
            ...
            success: function(response){
                if(response['valid']==false){
                    ...
                    if(action == 'add'){  
                        ...
                        html += "<td><input type='text' name='item_total' value='"+response['totalPrice']+"' style='border: none; width: 130px;' disabled='' ></td>";
    ...
    $.ajax({
      url : "insert_patient_name_billing.php",
        ...
        success : function(response) {
            ...
            window.location.reload();
            $("#sasa").val(response['transactionID']);
        }
});
    printDiv();
}else{
